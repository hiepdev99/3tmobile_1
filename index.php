                                                ...
                                                <li class='active has-sub'>
                                                    ...
                                                    <div class="menu_sub_all">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="sanpham.php">Iphone XSMax</a>
                                                            </li>
                                                            <li>
                                                                <a href="sanpham.php">Iphone 11 Pro Max</a>
                                                            </li>
                                                            <li>
                                                                <a href="sanpham.php">Iphone 12 Pro</a>
                                                            </li>
                                                            <div class="clear"></div>
                                                        </ul>
                                                        <span
                            ...
                            <div class="grids_in">
                                <div class="content">
                                    <div class="img-right-pro">
                                        ...
                                        <a href="sanpham.php">
                                            <img class="lazy img-pro content-image" src="image/mac.jpg"
                    ...
                    <div class="girds_all list_all_other_page ">
                        <div class="grids">
                            <div class="grids_in">
                                <div class="img-right-pro">
                                    <a href="sanpham.php">
                                        <img class="lazy img-pro" src="image/phukien.jpg"
                    ...
                    <div class="footer-col">
                        ...
                        <div class="footer-col-content">
                            <ul class="icon_list">
                                ...
                                <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i> https://3tphone.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
