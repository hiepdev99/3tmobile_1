        ...
        <div class="info_top">
            <div class="bg_in">
                <p class="p_infor">
                    ...
                    <span><i class="fa fa-phone" aria-hidden="true"></i> Hotline: 0862-241-298</span>
                </p>
            </div>
        </div>
                        ...
                        <div class="cart_wrapper">
                            <div class="cols_50">
                                <div class="hot_line_top">
                                    ...
                                    <br />
                                    <span class="red">Dương Văn Hiệp</span>
                                </div>
                            </div>
                            <div class="cols_50">
                                <div class="hot_line_top">
                                    ...
                                    <tr class="tr">
                                        <td data-th="Hình ảnh">
                                            <div class="col_table_image col_table_hidden-xs"><img
                                                    src="image/iphone1.jpg" alt="Máy in laser Canon LBP251DW"
                                        ...
                                        <td data-th="Số lượng">
                                            <div class="clear margintop5">
                                                <div class="floatleft"><input type="number" class="inputsoluong"
                                                        name="qty[576]" value="1"></div>
                                        ...
                                        <td data-th="Thành tiền" class="text_center"><span
                                                class="color_red font_money">0 đ</span></td>
                                        <td class="actions aligncenter" data-th="">
                                            <a onclick="return del(576,'Máy in laser Canon LBP251DW');"
                            ...
                            <div class="ch-contacts-details">
                                <ul class="contact-list">
                                    <li class="addr">
                                        ...
                                        <p>CN: 13 Đường Hồng, Thanh Đa, Phúc Thọ, Hà Nội</p>
                                        <p> Hotline: 0862-241-298 - 0869-305-283 (zalo)</p>
                                        </p>
                                    </li>
                                </ul>
                                <div class="hiring-box">
                                    ...
                                    <p>Mọi thắc mắc bạn hãy gửi về mail của chúng tôi
                                        <strong>3tmobile@webextrasite.com</strong> chúng tôi sẽ giải đáp cho bạn.
                                    </p>
                                    <p><a href="." class="arrow-link"><i class="fa fa-long-arrow-left"
                                                aria-hidden="true"></i> Về trang chủ</a></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="icon_list">
                                <li>
                                    <a href=".">
                                        ...
                                        <p class="text_li">
                                            <span class="phone_footer">Hotline:0862-241-298 </span>
